...
import img1 from "../assets/images/prd2 (1).webp"
import img2 from "../assets/images/prd2 (2).webp"
import img3 from "../assets/images/prd2 (3).webp"
import img4 from "../assets/images/prd2 (4).webp"
import back from "../assets/icons/back.png"

function ThiProductpage() {
        ...
        <div className=''>
            <div className='pt-[6rem] containers max-w-[1340px] w-[95%]'>
                ...
                <div className='2xl:pb-[5rem] 2xl:pt-[4rem] xl:pb-[5rem] xl:pt-[4rem] lg:pb-[5rem] lg:pt-[4rem] md:pb-[5rem] md:pt-[4rem] sm:pb-[5rem] sm:pt-[4rem]   pb-[2rem] pt-[2rem] text-center'>
                    <h3 className='2xl:text-[52px] xl:text-[52px] lg:text-[52px] md:text-[52px] sm:text-[52px] text-[32px] font-[400] '>Stott and May. <br />
                    Technology recruitment</h3>
                ...
                <div className='flex justify-between 2xl:py-12 xl:py-12 lg:py-12 md:py-12 sm:py-12 py-6'>
                    <div className='w-[20%]'>
                        ...
                        <h4 className='2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[12px] font-[600]'>Recruitment</h4>
                    </div>
                    <div className='w-[37%]'>
                        ...
                        <h4 className='2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[12px] font-[600]'>Branding, Animations, HubSpot website, Logo design, Print design, SMM, Web design</h4>
                    </div>
                    <div className='w-[22%]'>
