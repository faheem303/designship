...
import img1 from "../assets/images/prd4 (1).jpg"
import img2 from "../assets/images/prd4 (2).jpg"
import img3 from "../assets/images/prd4 (3).jpg"
import img4 from "../assets/images/prd4 (4).jpg"
import back from "../assets/icons/back.png"

function FourProductpage() {
        ...
        <div className='bg-white'>
            <div className='pt-[6rem] containers max-w-[1340px] w-[95%]'>
                ...
                <div className='2xl:pb-[5rem] 2xl:pt-[4rem] xl:pb-[5rem] xl:pt-[4rem] lg:pb-[5rem] lg:pt-[4rem] md:pb-[5rem] md:pt-[4rem] sm:pb-[5rem] sm:pt-[4rem]   pb-[2rem] pt-[2rem] text-center'>
                    <h3 className='2xl:text-[52px] xl:text-[52px] lg:text-[52px] md:text-[52px] sm:text-[52px] text-[32px] font-[400] '>Femme Type. <br />
                    Celebrating Women in the Type Industry</h3>
                </div>
                <div className='flex justify-between 2xl:py-12 xl:py-12 lg:py-12 md:py-12 sm:py-12 py-6'>
                    <div className='w-[20%]'>
                        ...
                        <h4 className='2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[12px] font-[600]'>Design</h4>
                    </div>
                    <div className='w-[37%]'>
                        ...
                        <h4 className='2xl:text-[16px] xl:text-[16px] lg:text-[16px] md:text-[16px] sm:text-[16px] text-[12px] font-[600]'>Web design, Ecommerce, Elementor website, UI/UX design</h4>
                    </div>
                    <div className='w-[22%]'>
...
export default FourProductpage;
