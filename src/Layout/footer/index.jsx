...
function Footer() {
  return (
    <div className="bg-[#4a4f74] bg-main  ">
      <div className="py-[5rem] containers 2xl:space-y-0 xl:space-y-0 lg:space-y-0 md:space-y-0 sm:space-y-8 space-y-8 2xl:flex xl:flex lg:flex md:flex sm:flex block justify-betwen">
